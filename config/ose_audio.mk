...
ALARM_PATH := vendor/ose/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/ose/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/ose/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/ose/prebuilt/common/media/audio/ui
